namespace Minesweeper
{
    partial class 지뢰찾기
    {
        ...
        private void InitializeComponent()
        {
            ...
            나가기예약ToolStripMenuItem = new ToolStripMenuItem();
            나가기ToolStripMenuItem = new ToolStripMenuItem();
            ...
            메뉴ToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { 새로시작ToolStripMenuItem, asdToolStripMenuItem, 난이도ToolStripMenuItem });
            메뉴ToolStripMenuItem.Name = "메뉴ToolStripMenuItem";
            메뉴ToolStripMenuItem.Size = new Size(60, 30);
            ...
            // 
            asdToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { 시작하기ToolStripMenuItem, 나가기예약ToolStripMenuItem, 나가기ToolStripMenuItem });
            ...
            시작하기ToolStripMenuItem.Size = new Size(138, 22);
            시작하기ToolStripMenuItem.Text = "시작하기";
            시작하기ToolStripMenuItem.Click += 시작하기ToolStripMenuItem_Click;
            // 
            // 나가기예약ToolStripMenuItem
            // 
            나가기예약ToolStripMenuItem.Name = "나가기예약ToolStripMenuItem";
            나가기예약ToolStripMenuItem.Size = new Size(138, 22);
            나가기예약ToolStripMenuItem.Text = "나가기 예약";
            나가기예약ToolStripMenuItem.Click += 나가기예약ToolStripMenuItem_Click;
            // 
            // 나가기ToolStripMenuItem
            // 
            나가기ToolStripMenuItem.Name = "나가기ToolStripMenuItem";
            나가기ToolStripMenuItem.Size = new Size(138, 22);
            나가기ToolStripMenuItem.Text = "나가기";
            나가기ToolStripMenuItem.Click += 나가기ToolStripMenuItem_ClickAsync;
            // 
            // 난이도ToolStripMenuItem
            // 
            난이도ToolStripMenuItem.Name = "난이도ToolStripMenuItem";
            난이도ToolStripMenuItem.Size = new Size(180, 22);
            난이도ToolStripMenuItem.Text = "난이도 설정";
            난이도ToolStripMenuItem.Click += 난이도설정ToolStripMenuItem_Click;
            // 
        ...
        private ToolStripMenuItem 나가기예약ToolStripMenuItem;
        ...
        private ToolStripMenuItem 나가기ToolStripMenuItem;
    }
}
