...
namespace MinesweeperServer
{
    ...
    class Room
    {
        ...
        public int Player_Count { get; private set; } = 0;
        ...
        public Room(int roomId, Player p1, Player p2, int level)
        {
            ...
            if (Player1 != null) Player_Count++;
            if (Player2 != null) Player_Count++;
        }

        public bool IsRoomNormal()
        {
        ...
        public Player GetOppPlayer(Player player)
        {
        ...
        public void DestroyRoom()
        {
            ...
            // 로그 출력 (선택)
            Console.WriteLine($"Room {RoomId} has been destroyed.");
        }

        public string GetGamePanSize()
        {
            string str = $"x = {GAMEPAN[Level, 0]} y = {GAMEPAN[Level,1]} ";
            return str;
        }

        public bool IsReservationPlayer()
        {
        ...
        public int WhoIsReservation()
        {
            int n = 0;
            // return 0 은 없음, 1은 player1  2는 player2  3은 전부
            if (Player1.IsReservation() != 0) n += 1;
            if (Player2.IsReservation() != 0) n += 2;
