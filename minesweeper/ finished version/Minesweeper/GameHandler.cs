...
namespace Minesweeper
{
    ...
    public class GameCommandHandler
    {
        ...
        public void HandleResult(int sendNo, int recvNo, string data)
        {
            ...
            IGame.AlertInstance = new Alert($"{result}\n다시 하시려면 Yes, 대기실로 돌아가시려면 No", $"Player{IGame.MySocketNo + 1} 결과", "YesOrNo");
    ...
    public class SystemCommandHandler
    {
        ...
        public void HandleCloseRoom(string data)
        {
            string result = data switch
            {
                "Win" => "승리하셨습니다.",
    ...
    public class ClientCommandHandler
    {
        ...
        public void HandleExit(string data)
        {
            if (IGame.NetworkInstance != null)
            {
                IGame.NetworkInstance.Disconnect(); // Receive 루프 안전 종료
                IGame.NetworkInstance = null;
            }
            ...
            IGame.CallSetToolStripMenuVisible(false);
        }
    }
