    ...
    */
    ...
    public partial class 지뢰찾기 : Form
    {
        ...
        void HandleResultCommand(int sendNo, int recvNo, string data)
        {
            ...
            {
                network.SendMessage(CommandType.Game, mySocketNo, serverNo, GameAction.ReGame, "", "결과");
                GameReset();
            }
            else
            {
                network.SendMessage(CommandType.Game, mySocketNo, serverNo, GameAction.Exit, "", "결과");
            }
