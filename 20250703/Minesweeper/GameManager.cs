...
namespace Minesweeper
{
    ...
    internal class GameManager
    {
        ...
        public void SoloGameInit(Mine[,] buttons)
        {
            RandomLayingMine(buttons, SOLO_LEVEL);
            DetectorMine(buttons, SOLO_LEVEL);
        }
        public void MultiGameInit(Mine[,] buttons)
        {
            DetectorMine(buttons , MULTI_LEVEL);
        }
      
        void RandomLayingMine(Mine[,] buttons, int level)
        {
        ...
        void DetectorMine(Mine[,] buttons ,int level)
        {
        ...
        // GameManager 내부
        public List<Point> GetButtonsToOpenByZeroDetector(Mine[,] buttons , Point start, bool isSolo)
        {
        ...
        public bool IsGameClear(Mine[,] buttons, bool solo)
        {
            int level = -1;
