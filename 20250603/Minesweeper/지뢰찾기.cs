...
namespace Minesweeper
{
    ...
    */
    ...
    public partial class 지뢰찾기 : Form
    {
        ...
        private void HandleMineAction(int sendNo, int recvNo, string action, string data)
        {
        ...
        void HandleGameCommand(int sendNo, int recvNo, string action, string data)
        {
            ...
            //HandleMineAction(sendNo, recvNo, action, data);
        }
        ...
        void HandleMineMapCommand(int sendNo, int recvNo, string data)
        {
            List<Point> mine = MineLaying(data);
